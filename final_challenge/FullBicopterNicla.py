...
if __name__ == "__main__":
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "kppyaw", 0.2) #2, 0.1
    serial.send_preference(ROBOT_MAC, DataType_Float, "kdyaw", 0)#.1
    serial.send_preference(ROBOT_MAC, DataType_Float, "kddyaw", 0.2)#.1
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "by_strength", 1)

    serial.send_preference(ROBOT_MAC, DataType_Float, "x_strength", 1)

    serial.send_preference(ROBOT_MAC, DataType_Float, "fx_togoal", 0.4)#0.15
    serial.send_preference(ROBOT_MAC, DataType_Float, "fx_charge", 0.6)#0.3
    serial.send_preference(ROBOT_MAC, DataType_Float, "bfx_charge", 0.6)
    ...
    try:
        while True:
            ...
            if height > 15:
                ...
                height = -3
            fz = height+3
            print(axis[0], axis[1], axis[2], height)
            # roll controller
            # if abs(axis[1]) < .15:
            #     axis[1] = 0
            # tx = axis[1] * .2
